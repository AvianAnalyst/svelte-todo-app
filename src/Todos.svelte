...
<div class="container">
    ...
    <div class="inner-container">
        <div>
            <label>
                <input class="inner-container-input" type="checkbox"
    ...
    <div class="inner-container">
        <div>
            <button on:click="{() => updateFilter('all')}"
                    class:active="{currentFilter === 'all'}">All</button>
            <button on:click="{() => updateFilter('active')}"
                    class:active="{currentFilter === 'active'}">Active</button>
            <button on:click="{() => updateFilter('completed')}"
